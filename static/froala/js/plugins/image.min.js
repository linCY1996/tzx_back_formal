...
! function(a) { "function" == typeof define && define.amd ? define(["jquery"], a) : "object" == typeof module && module.exports ? module.exports = function(e, t) { return t === undefined && (t = "undefined" != typeof window ? require("jquery") : require("jquery")(e)), a(t) } : a(window.jQuery) }(function(be) {
    be.extend(be.FE.POPUP_TEMPLATES, { "image.insert": "[_BUTTONS_][_UPLOAD_LAYER_][_BY_URL_LAYER_][_PROGRESS_BAR_]", "image.edit": "[_BUTTONS_]", "image.alt": "[_BUTTONS_][_ALT_LAYER_]", "image.size": "[_BUTTONS_][_SIZE_LAYER_]" }), be.extend(be.FE.DEFAULTS, { imageInsertButtons: ["imageBack", "|", "imageUpload", "imageByURL"], imageEditButtons: ["imageReplace", "imageAlign", "imageCaption", "imageRemove", "|", "imageLink", "linkOpen", "linkEdit", "linkRemove", "-", "imageDisplay", "imageStyle", "imageAlt", "imageSize"], imageAltButtons: ["imageBack", "|"], imageSizeButtons: ["imageBack", "|"], imageUpload: !0, imageUploadURL: null, imageCORSProxy: "https://cors-anywhere.froala.com", imageUploadRemoteUrls: !0, imageUploadParam: "file", imageUploadParams: {}, imageUploadToS3: !1, imageUploadMethod: "POST", imageMaxSize: 10485760, imageAllowedTypes: ["jpeg", "jpg", "png", "gif", "webp"], imageResize: !0, imageResizeWithPercent: !1, imageRoundPercent: !1, imageDefaultWidth: 300, imageDefaultAlign: "center", imageDefaultDisplay: "block", imageSplitHTML: !1, imageStyles: { "fr-rounded": "Rounded", "fr-bordered": "Bordered", "fr-shadow": "Shadow" }, imageMove: !0, imageMultipleStyles: !0, imageTextNear: !0, imagePaste: !0, imagePasteProcess: !1, imageMinWidth: 16, imageOutputSize: !1, imageDefaultMargin: 5, imageAddNewLine: !1 }), be.FE.PLUGINS.image = function(g) {
        var d, l, f, p, o, a, c = "/insert/wordsss",
            t = !1,
            i = 1,
            u = 2,
            m = 3,
        ...
        function E(e) {
            ...
            if (o && e) { var s = []; for (t = 0; t < o.length; t++) s.push(o[t].getAttribute("src")); for (t = 0; t < a.length; t++) s.indexOf(a[t].getAttribute("src")) < 0 && g.events.trigger("image.loaded", [be(a[t])]) }
            o = a
        }
        ...
        function C() {
            if (l || function() {
                    var e;
                    g.shared.$image_resizer ? (l = g.shared.$image_resizer, p = g.shared.$img_overlay, g.events.on("destroy", function() { l.removeClass("fr-active").appendTo(be("body:first")) }, !0)) : (g.shared.$image_resizer = be('<div class="fr-image-resizer"></div>'), l = g.shared.$image_resizer, g.events.$on(l, "mousedown", function(e) { e.stopPropagation() }, !0), g.opts.imageResize && (l.append(s("nw") + s("ne") + s("sw") + s("se")), g.shared.$img_overlay = be('<div class="fr-image-overlay"></div>'), p = g.shared.$img_overlay, e = l.get(0).ownerDocument, be(e).find("body:first").append(p)));
                    g.events.on("shared.destroy", function() { l.html("").removeData().remove(), l = null, g.opts.imageResize && (p.remove(), p = null) }, !0), g.helpers.isMobile() || g.events.$on(be(g.o_win), "resize", function() { d && !d.hasClass("fr-uploading") ? se(!0) : d && (C(), ce(), I(!1)) });
                    if (g.opts.imageResize) {
                        ...
                        }, !0), g.events.on("keyup", function() { i = 1 })
                    }
                }(), !d) return !1;
            var e = g.$wp || g.$sc;
        ...
        function A(e) { ve() ? d.parents(".fr-img-caption").css("width", e) : d.css("width", e) }
        ...
        function R(e) {
            ...
            if ("mousedown" == e.type) {
                var a = g.$oel.get(0).ownerDocument,
                    ...
                    r = !1;
                try { r = i.location != i.parent.location && !(i.$ && i.$.FE) } catch (o) {}
        ...
        function x(e, t, a) {
            g.edit.on(), d && d.addClass("fr-error"),
                ...
                }(g.language.translate("Something went wrong. Please try again.")), !d && a && Q(a), g.events.trigger("image.error", [{ code: e, message: r[e] }, t, a])
        }

        function U(e) { if (e) return g.$wp && g.events.$on(g.$wp, "scroll.image-edit", function() { d && g.popups.isVisible("image.edit") && (g.events.disableBlur(), n()) }), !0; var t = ""; if (0 < g.opts.imageEditButtons.length) { t += '<div class="fr-buttons">', t += g.button.buildList(g.opts.imageEditButtons); var a = { buttons: t += "</div>" }; return g.popups.create("image.edit", a) } return !1 }
        ...
        function B(s, e, o, l, f) {
            ...
            }, t.onerror = function() { x(i) }, I(g.language.translate("Loading image")), t.src = s
        }
                ...
                if (g.opts.imageUploadToS3)
                    if (201 == t) {
                        var n = function(e) {
                            ...
                            } catch (i) { return x(h, e), !1 }
                        }(i);
                        n && B(n, !1, [], e, a || i)
                    } else x(h, a || i, e);
                else if (200 <= t && t < 300) {
                    var s = function(e) { try { if (!1 === g.events.trigger("image.uploaded", [e], !0)) return g.edit.on(), !1; var t = JSON.parse(e); return t.link ? t : (x(u, e), !1) } catch (a) { return x(h, e), !1 } }(r);
                    s && B(s.link, !1, s, e, a || r)
                } else x(m, a || r, e)
            } catch (o) { x(h, a || r, e) }
        }

        function P() { x(h, this.response || this.responseText || this.responseXML) }
                ...
                if (g.drag_support.formdata && (a = g.drag_support.formdata ? new FormData : null), a) {
                    ...
                    g.opts.imageUploadToS3 && (n = g.opts.imageUploadToS3.uploadURL ? g.opts.imageUploadToS3.uploadURL : "https://" + g.opts.imageUploadToS3.region + ".amazonaws.com/" + g.opts.imageUploadToS3.bucket),
                        function(t, a, e, r) {
                            function n() {
                                var e = be(this);
                                e.off("load"), e.addClass("fr-uploading"), e.next().is("br") && e.next().remove(), g.placeholder.refresh(), k(e), C(), I(), g.edit.off(), t.onload = function() { O.call(t, e) }, t.onerror = P, t.upload.onprogress = T, t.onabort = M, e.off("abortUpload").on("abortUpload", function() { 4 != t.readyState && t.abort() }), t.send(a)
                            }
        ...
        function _(e) { if (e.is("img") && 0 < e.parents(".fr-img-caption").length) return e.parents(".fr-img-caption") }
        ...
        function W(e) {
            ...
            var f, p = { buttons: i, upload_layer: o, by_url_layer: l, progress_bar: '<div class="fr-image-progress-bar-layer fr-layer"><h3 tabIndex="-1" class="fr-message">Uploading</h3><div class="fr-loader"><span class="fr-progress"></span></div><div class="fr-action-buttons"><button type="button" class="fr-command fr-dismiss" data-cmd="imageDismissError" tabIndex="2" role="button">OK</button></div></div>' };
            return 1 <= g.opts.imageInsertButtons.length && (a = g.popups.create("image.insert", p)), g.$wp && g.events.$on(g.$wp, "scroll", function() { d && g.popups.isVisible("image.insert") && ce() }), f = a, g.events.$on(f, "dragover dragenter", ".fr-image-upload-layer", function() { return be(this).addClass("fr-drop"), !1 }, !0), g.events.$on(f, "dragleave dragend", ".fr-image-upload-layer", function() { return be(this).removeClass("fr-drop"), !1 }, !0), g.events.$on(f, "drop", ".fr-image-upload-layer", function(e) {
            ...
            }, !0), g.helpers.isIOS() && g.events.$on(f, "touchstart", '.fr-image-upload-layer input[type="file"]', function() { be(this).trigger("click") }, !0), g.events.$on(f, "change", '.fr-image-upload-layer input[type="file"]', function() {
                if (this.files) {
        ...
        function H() { d && g.popups.get("image.alt").find("input").val(d.attr("alt") || "").trigger("change") }
        ...
        function V(e) {
            ...
            var t = { buttons: '<div class="fr-buttons">' + g.button.buildList(g.opts.imageSizeButtons) + "</div>", size_layer: '<div class="fr-image-size-layer fr-layer fr-active" id="fr-image-size-layer-' + g.id + '"><div class="fr-image-group"><div class="fr-input-line"><input id="fr-image-size-layer-width-' + g.id + '" type="text" name="width" placeholder="' + g.language.translate("Width") + '" tabIndex="1"></div><div class="fr-input-line"><input id="fr-image-size-layer-height' + g.id + '" type="text" name="height" placeholder="' + g.language.translate("Height") + '" tabIndex="1"></div></div><div class="fr-action-buttons"><button type="button" class="fr-command fr-submit" data-cmd="imageSetSize" tabIndex="2" role="button">' + g.language.translate("Update") + "</button></div></div>" },
                a = g.popups.create("image.size", t);
            return g.$wp && g.events.$on(g.$wp, "scroll.image-size", function() { d && g.popups.isVisible("image.size") && G() }), a
        }

        function q(e, t, a, i) { return e.pageX = t, R.call(this, e), e.pageX = e.pageX + a * Math.floor(Math.pow(1.1, i)), S.call(this, e), D.call(this, e), ++i }
        ...
        function ee(e) {
            ...
            d = be(e), C(), n(), ce(), I(), d.one("load", function() { C(), I() });
                ...
                if (0 === a.src.indexOf("data:")) ee(a);
                    ...
                    i.crossOrigin = "Anonymous", i.onload = function() {
                        var e = g.o_doc.createElement("CANVAS"),
                            t = e.getContext("2d");
                        e.height = this.naturalHeight, e.width = this.naturalWidth, t.drawImage(this, 0, 0), setTimeout(function() { ee(a) }, 0), a.src = e.toDataURL("image/jpeg")
        ...
        function re(e) { return e = e.replace(/<img /gi, '<img data-fr-image-pasted="true" ') }
        ...
        function se(e) { d && (oe || !0 === e) && (g.toolbar.enable(), l.removeClass("fr-active"), g.popups.hide("image.edit"), d = null, fe(), f = null, p && p.hide()) }
        ...
        function me() { return d }

        function he() { return ve() ? d.parents(".fr-img-caption:first") : d }

        function ve() { return !!d && 0 < d.parents(".fr-img-caption").length }
        return {
            _init: function() {
                var i;
                ...
                }), "IMG" == g.el.tagName && g.$el.addClass("fr-view"), g.events.$on(g.$el, g.helpers.isMobile() && !g.helpers.isWindowsPhone() ? "touchend" : "click", "IMG" == g.el.tagName ? null : 'img:not([contenteditable="false"])', ne), g.helpers.isMobile() && (g.events.$on(g.$el, "touchstart", "IMG" == g.el.tagName ? null : 'img:not([contenteditable="false"])', function() { a = !1 }), g.events.$on(g.$el, "touchmove", function() { a = !0 })), g.$wp ? (g.events.on("window.keydown keydown", J, !0), g.events.on("keyup", function(e) { if (d && e.which == be.FE.KEYCODE.ENTER) return !1 }, !0), g.events.$on(g.$el, "keydown", function() {
                ...
                }, !0), g.events.on("toolbar.focusEditor", function() { if (d) return !1 }, !0), g.events.on("window.cut window.copy", function(e) {
                    if (d && g.popups.isVisible("image.edit") && !g.popups.get("image.edit").find(":focus").length) {
                        var t = he();
                        ve() ? (t.before(be.FE.START_MARKER), t.after(be.FE.END_MARKER), g.selection.restore(), g.paste.saveCopiedText(t.get(0).outerHTML, t.text())) : (ue(), g.paste.saveCopiedText(d.get(0).outerHTML, d.attr("alt"))), "copy" == e.type ? setTimeout(function() { k(d) }) : (se(!0), g.undo.saveStep(), setTimeout(function() { g.undo.saveStep() }, 0))
                    }
                ...
                }), g.opts.iframe && g.events.on("image.loaded", g.size.syncIframe), g.$wp && (E(), g.events.on("contentChanged", E)), g.events.$on(be(g.o_win), "orientationchange.image", function() { setTimeout(function() { d && k(d) }, 100) }), U(!0), W(!0), V(!0), X(!0), g.events.on("node.remove", function(e) { if ("IMG" == e.get(0).tagName) return Q(e), !1 })
            },
            showInsertPopup: function() {
                var e = g.$tb.find('.fr-command[data-cmd="insertImage"]'),
                    t = g.popups.get("image.insert");
                if (t || (t = W()), $(), !t.hasClass("fr-active"))
            ...
            refreshUploadButton: function(e) { g.popups.get("image.insert").find(".fr-image-upload-layer").hasClass("fr-active") && e.addClass("fr-active").attr("aria-pressed", !0) },
            refreshByURLButton: function(e) { g.popups.get("image.insert").find(".fr-image-by-url-layer").hasClass("fr-active") && e.addClass("fr-active").attr("aria-pressed", !0) },
            upload: z,
            insertByURL: function() {
                ...
                if (0 < e.val().length) {
                    ...
                    if (g.opts.imageUploadRemoteUrls && g.opts.imageCORSProxy && g.opts.imageUpload) {
                        ...
                        a.onload = function() { 200 == this.status ? z([new Blob([this.response], { type: this.response.type || "image/png" })], d) : x(i) }, a.onerror = function() { B(t, !0, [], d) }, a.open("GET", g.opts.imageCORSProxy + "/" + t, !0), a.responseType = "blob", a.send()
                    } else B(t, !0, [], d);
                    e.val(""), e.blur()
                }
            },
            ...
            refreshAlign: function(e) { d && e.find("> *:first").replaceWith(g.icon.create("image-align-" + ge())) },
            refreshAlignOnShow: function(e, t) { d && t.find('.fr-command[data-param1="' + ge() + '"]').addClass("fr-active").attr("aria-selected", !0) },
            display: function(e) {
                var t = he();
            ...
            refreshDisplayOnShow: function(e, t) { d && t.find('.fr-command[data-param1="' + de() + '"]').addClass("fr-active").attr("aria-selected", !0) },
            replace: ce,
            back: function() { d ? (g.events.disableBlur(), be(".fr-popup input:focus").blur(), k(d)) : (g.events.disableBlur(), g.selection.restore(), g.events.enableBlur(), g.popups.hide("image.insert"), g.toolbar.showInline()) },
            get: me,
            getEl: he,
            insert: B,
            showProgressBar: I,
